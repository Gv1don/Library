<div class="headTable">
    <h2 class="tableName">История посещений</h2>
    <form action="{{ route('create') }}" method="GET">
        @csrf
        <button name="type" value="story" type="submit" class="btn btn-primary" style="margin-top: 30px; max-height: 40px; max-width: 200px">+ Добавить запись</button>
    </form>
</div>
