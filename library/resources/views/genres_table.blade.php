<div class="headTable">
    <h2 class="tableName">Жанры</h2>
    <form action="{{ route('create') }}" method="GET">
        @csrf
        <button name="type" value="genres" type="submit" class="btn btn-primary" style="margin-top: 30px; max-height: 40px; max-width: 200px">+ Добавить жанр</button>
    </form>
</div>
<div class="table-responsive">
    <table class="table table-striped table-lg table-hover">
        <thead>
            <tr>
                <th class="text-center" >Название жанра</th>
